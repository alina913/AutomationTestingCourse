...
public class MainPageObject {
    ...
    public WebElement waitForElementPresent(String locator, String error_message, Duration timeoutInSeconds){
        ...
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds.getSeconds());
    ...
    public WebElement waitForElementPresent(String locator, String error_message){
        return waitForElementPresent(locator, error_message, Duration.ofSeconds(15));
    }

    public WebElement waitForElementAndClick(String locator, String error_message, Duration timeoutInSeconds){
        WebElement element = waitForElementPresent(locator, error_message, Duration.ofSeconds(5));
        element.click();
        return element;
    }
    ...
    public void assertElementHasText(String text_actual, String text_expected, String error_message) {
        assertEquals(error_message, text_expected, text_actual);
    }
    ...
    public boolean isElementLocatedOnTheScreen(String locator){
        int element_location_by_y = this.waitForElementPresent(locator, "Cannot find element by locator"+locator, Duration.ofSeconds(1)).getLocation().getY();
    ...
    private By getLocatorByString(String locator_with_type) {
        ...
        else throw new IllegalArgumentException("Can't process this type of locator: " + by_type);
    }
}
